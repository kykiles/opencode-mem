...
async function main() {
  ...
  console.log(`   Claude-mem: v${diagnostics.versions.opencodeMem}`);
  ...
  const githubUrl = `https://github.com/kykiles/opencode-mem/issues/new?title=${encodedTitle}&body=${encodedBody}`;
