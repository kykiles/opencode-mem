...
或为 Antigravity CLI 安装([设置指南](https://docs.opencode-mem.ai/antigravity-cli/setup)):
...
> **注意:** Claude-Mem 也已发布到 npm,但 `npm install -g opencode-mem` 仅安装 **SDK/库本身** —— 它不会注册插件钩子,也不会设置 worker 服务。请始终通过 `npx opencode-mem install` 或上述 `/plugin` 命令进行安装。

### 🦞 OpenClaw Gateway

只需一条命令,即可在 [OpenClaw](https://openclaw.ai) 网关上将 opencode-mem 安装为持久化内存插件:

```bash
curl -fsSL https://install.cmem.ai/openclaw.sh | bash
```

该安装程序会处理依赖项、插件设置、AI 提供商配置、worker 启动,以及可选的向 Telegram、Discord、Slack 等平台的实时观察推送。详情请参阅 [OpenClaw 集成指南](https://docs.opencode-mem.ai/openclaw-integration)。
...
- **[使用指南](https://docs.opencode-mem.ai/usage/getting-started)** - Claude-Mem 如何自动工作
...
- **[渐进式披露](https://docs.opencode-mem.ai/progressive-disclosure)** - Claude-Mem 上下文启动策略背后的哲学
...
- **[钩子架构](https://docs.opencode-mem.ai/hooks-architecture)** - Claude-Mem 如何使用生命周期钩子
...
- **[发布分支](https://docs.opencode-mem.ai/branches)** - Stable、core-dev 和 community-edge 分支流程
...
**[发布分支](https://docs.opencode-mem.ai/branches)** 了解分支流程和非稳定版运行说明。
...
Claude-Mem 通过 `OPENCODE_MEM_MODE` 设置支持多种工作流模式和语言。
...
编辑位于 `~/.opencode-mem/settings.json` 的设置文件:
...
[发布分支](https://docs.opencode-mem.ai/branches) 了解相关策略和本地运行说明。
...
- **文档**: [docs/](docs/)
- **问题反馈**: [GitHub Issues](https://github.com/kykiles/opencode-mem/issues)
- **仓库**: [github.com/kykiles/opencode-mem](https://github.com/kykiles/opencode-mem)
