...
או התקן עבור Antigravity CLI ([מדריך הגדרה](https://docs.opencode-mem.ai/antigravity-cli/setup)):
...
> **הערה:** Claude-Mem מפורסם גם ב-npm, אך `npm install -g opencode-mem` מתקין רק את **ה-SDK/ספרייה** — הוא אינו רושם את hooks התוסף ואינו מגדיר את שירות ה-worker. תמיד יש להתקין באמצעות `npx opencode-mem install` או פקודות `/plugin` שלעיל.

### 🦞 OpenClaw Gateway

התקן את opencode-mem כתוסף זיכרון מתמשך על שערי [OpenClaw](https://openclaw.ai) בפקודה בודדת:

```bash
curl -fsSL https://install.cmem.ai/openclaw.sh | bash
```

תוכנת ההתקנה מטפלת בתלויות, בהגדרת התוסף, בהגדרת ספק ה-AI, בהפעלת ה-worker, ובאפשרות להזין זרימות תצפיות בזמן אמת ל-Telegram, Discord, Slack ועוד. עיין ב[מדריך שילוב OpenClaw](https://docs.opencode-mem.ai/openclaw-integration) לפרטים.
...
- **[מדריך שימוש](https://docs.opencode-mem.ai/usage/getting-started)** - איך Claude-Mem עובד אוטומטית
...
- **[גילוי מדורג](https://docs.opencode-mem.ai/progressive-disclosure)** - הפילוסופיה מאחורי אסטרטגיית הכנת ההקשר של Claude-Mem

### ארכיטקטורה

- **[סקירה כללית](https://docs.opencode-mem.ai/architecture/overview)** - רכיבי המערכת וזרימת הנתונים
- **[התפתחות הארכיטקטורה](https://docs.opencode-mem.ai/architecture-evolution)** - המסע מגרסה v3 לגרסה v5
- **[ארכיטקטורת Hooks](https://docs.opencode-mem.ai/hooks-architecture)** - איך Claude-Mem משתמש ב-lifecycle hooks
...
- **[ענפי שחרור](https://docs.opencode-mem.ai/branches)** - זרימת הענפים Stable, core-dev, ו-community-edge
...
קהילתיים. ראה **[ענפי שחרור](https://docs.opencode-mem.ai/branches)**
...
Claude-Mem תומך במספר מצבי עבודה ושפות דרך ההגדרה `OPENCODE_MEM_MODE`.
...
ערוך את קובץ ההגדרות שלך ב-`~/.opencode-mem/settings.json`:
...
ראה [ענפי שחרור](https://docs.opencode-mem.ai/branches) לאסטרטגיה ולהוראות
הרצה מקומיות.
...
- **תיעוד**: [docs/](docs/)
- **בעיות**: [GitHub Issues](https://github.com/kykiles/opencode-mem/issues)
- **מאגר**: [github.com/kykiles/opencode-mem](https://github.com/kykiles/opencode-mem)
