...
O instala para Antigravity CLI ([guía de configuración](https://docs.opencode-mem.ai/antigravity-cli/setup)):
...
> **Nota:** Claude-Mem también está publicado en npm, pero `npm install -g opencode-mem` instala **únicamente el SDK/librería** — no registra los hooks del plugin ni configura el servicio worker. Instala siempre mediante `npx opencode-mem install` o los comandos `/plugin` mencionados arriba.

### 🦞 OpenClaw Gateway

Instala opencode-mem como plugin de memoria persistente en gateways de [OpenClaw](https://openclaw.ai) con un solo comando:
...
- **[Guía de Uso](https://docs.opencode-mem.ai/usage/getting-started)** - Cómo funciona Claude-Mem automáticamente
...
- **[Divulgación Progresiva](https://docs.opencode-mem.ai/progressive-disclosure)** - Filosofía detrás de la estrategia de preparación de contexto de Claude-Mem
...
- **[Arquitectura de Hooks](https://docs.opencode-mem.ai/hooks-architecture)** - Cómo Claude-Mem usa hooks de ciclo de vida
...
- **[Ramas de Publicación](https://docs.opencode-mem.ai/branches)** - Flujo de las ramas stable, core-dev y community-edge
...
de fiabilidad e integraciones de la comunidad. Consulta **[Ramas de Publicación](https://docs.opencode-mem.ai/branches)**
...
Claude-Mem admite múltiples modos de flujo de trabajo e idiomas a través del ajuste `OPENCODE_MEM_MODE`.
...
Edita tu archivo de ajustes en `~/.opencode-mem/settings.json`:
...
el código fuente. Consulta [Ramas de Publicación](https://docs.opencode-mem.ai/branches) para conocer la
