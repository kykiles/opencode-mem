...
Hoặc cài đặt cho Antigravity CLI ([hướng dẫn cài đặt](https://docs.opencode-mem.ai/antigravity-cli/setup)):
...
> **Lưu ý:** Claude-Mem cũng được phát hành trên npm, nhưng `npm install -g opencode-mem` chỉ cài đặt **SDK/thư viện** — nó không đăng ký các hook của plugin hay thiết lập dịch vụ worker. Hãy luôn cài đặt qua `npx opencode-mem install` hoặc các lệnh `/plugin` ở trên.

### 🦞 OpenClaw Gateway

Cài đặt opencode-mem như một plugin bộ nhớ liên tục trên các gateway [OpenClaw](https://openclaw.ai) chỉ với một lệnh duy nhất:

```bash
curl -fsSL https://install.cmem.ai/openclaw.sh | bash
```

Trình cài đặt xử lý các phần phụ thuộc, thiết lập plugin, cấu hình nhà cung cấp AI, khởi động worker, và tùy chọn gửi luồng quan sát thời gian thực đến Telegram, Discord, Slack, và nhiều hơn nữa. Xem [Hướng Dẫn Tích Hợp OpenClaw](https://docs.opencode-mem.ai/openclaw-integration) để biết chi tiết.
...
- **[Hướng Dẫn Sử Dụng](https://docs.opencode-mem.ai/usage/getting-started)** - Cách Claude-Mem hoạt động tự động
...
- **[Tiết Lộ Tuần Tự](https://docs.opencode-mem.ai/progressive-disclosure)** - Triết lý đằng sau chiến lược chuẩn bị ngữ cảnh của Claude-Mem
...
- **[Kiến Trúc Hooks](https://docs.opencode-mem.ai/hooks-architecture)** - Cách Claude-Mem sử dụng lifecycle hooks
...
- **[Nhánh Phát Hành](https://docs.opencode-mem.ai/branches)** - Luồng các nhánh stable, core-dev, và community-edge
...
sớm và các tích hợp cộng đồng. Xem **[Nhánh Phát Hành](https://docs.opencode-mem.ai/branches)**
...
Claude-Mem hỗ trợ nhiều chế độ làm việc và ngôn ngữ thông qua cài đặt `OPENCODE_MEM_MODE`.
...
Chỉnh sửa tệp cài đặt của bạn tại `~/.opencode-mem/settings.json`:
...
mã nguồn. Xem [Nhánh Phát Hành](https://docs.opencode-mem.ai/branches) để biết
...
- **Tài Liệu**: [docs/](docs/)
- **Vấn Đề**: [GitHub Issues](https://github.com/kykiles/opencode-mem/issues)
