...
或為 Antigravity CLI 安裝（[設定指南](https://docs.opencode-mem.ai/antigravity-cli/setup)）：
...
> **注意：** Claude-Mem 也發布於 npm，但 `npm install -g opencode-mem` 僅安裝 **SDK/函式庫**——它不會註冊外掛掛鉤或設定 Worker 服務。請務必透過 `npx opencode-mem install` 或上述 `/plugin` 指令安裝。

### 🦞 OpenClaw Gateway

只需一個指令，即可在 [OpenClaw](https://openclaw.ai) 閘道上安裝 opencode-mem 作為持久記憶外掛：

```bash
curl -fsSL https://install.cmem.ai/openclaw.sh | bash
```

安裝程式會處理相依性、外掛設定、AI 提供者設定、Worker 啟動，以及選用的即時觀察推播至 Telegram、Discord、Slack 等平台。詳情請參閱 [OpenClaw 整合指南](https://docs.opencode-mem.ai/openclaw-integration)。
...
📚 **[檢視完整文件](https://docs.opencode-mem.ai/)** - 於官方網站瀏覽

### 入門指南

- **[安裝指南](https://docs.opencode-mem.ai/installation)** - 快速開始與進階安裝
- **[使用指南](https://docs.opencode-mem.ai/usage/getting-started)** - Claude-Mem 如何自動運作
...
- **[漸進式揭露](https://docs.opencode-mem.ai/progressive-disclosure)** - Claude-Mem 脈絡啟動策略背後的理念
...
- **[Hooks 架構](https://docs.opencode-mem.ai/hooks-architecture)** - Claude-Mem 如何使用生命週期掛鉤
...
- **[發布分支](https://docs.opencode-mem.ai/branches)** - Stable、core-dev 與 community-edge 分支流程
...
**[發布分支](https://docs.opencode-mem.ai/branches)**。
...
Claude-Mem 透過 `OPENCODE_MEM_MODE` 設定支援多種工作流程模式與語言。
...
編輯您位於 `~/.opencode-mem/settings.json` 的設定檔：
...
- **儲存庫**：[github.com/kykiles/opencode-mem](https://github.com/kykiles/opencode-mem)
