...
또는 Antigravity CLI용으로 설치하세요 ([설치 가이드](https://docs.opencode-mem.ai/antigravity-cli/setup)):
...
> **참고:** Claude-Mem은 npm에도 게시되어 있지만, `npm install -g opencode-mem`은 **SDK/라이브러리만** 설치합니다 — 플러그인 후크를 등록하거나 워커 서비스를 설정하지 않습니다. 항상 `npx opencode-mem install` 또는 위의 `/plugin` 명령을 통해 설치하세요.

### 🦞 OpenClaw 게이트웨이

한 줄 명령으로 [OpenClaw](https://openclaw.ai) 게이트웨이에 opencode-mem을 지속적인 메모리 플러그인으로 설치하세요:

```bash
curl -fsSL https://install.cmem.ai/openclaw.sh | bash
```

설치 프로그램은 종속성, 플러그인 설정, AI 제공업체 구성, 워커 시작, 그리고 Telegram, Discord, Slack 등으로의 선택적 실시간 관찰 피드를 처리합니다. 자세한 내용은 [OpenClaw 통합 가이드](https://docs.opencode-mem.ai/openclaw-integration)를 참조하세요.
...
- **[사용 가이드](https://docs.opencode-mem.ai/usage/getting-started)** - Claude-Mem이 자동으로 작동하는 방법
...
- **[점진적 공개](https://docs.opencode-mem.ai/progressive-disclosure)** - Claude-Mem의 컨텍스트 프라이밍 전략의 철학
...
- **[후크 아키텍처](https://docs.opencode-mem.ai/hooks-architecture)** - Claude-Mem이 라이프사이클 후크를 사용하는 방법
...
- **[릴리스 브랜치](https://docs.opencode-mem.ai/branches)** - Stable, core-dev, community-edge 브랜치 흐름
...
브랜치 흐름과 비안정 버전 실행 방법은 **[릴리스 브랜치](https://docs.opencode-mem.ai/branches)**를
참조하세요.
...
Claude-Mem은 `OPENCODE_MEM_MODE` 설정을 통해 다양한 워크플로우 모드와 언어를 지원합니다.
...
`~/.opencode-mem/settings.json`에 있는 설정 파일을 편집하세요:
...
전략과 로컬 실행 방법은 [릴리스 브랜치](https://docs.opencode-mem.ai/branches)를
참조하세요.
...
- **문서**: [docs/](docs/)
- **이슈**: [GitHub Issues](https://github.com/kykiles/opencode-mem/issues)
- **저장소**: [github.com/kykiles/opencode-mem](https://github.com/kykiles/opencode-mem)
