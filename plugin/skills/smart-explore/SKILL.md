...
### Custom Grammars (`.opencode-mem.json`)

You can register additional tree-sitter grammars for file types not in the bundled list. Create or update `.opencode-mem.json` in your project root:
